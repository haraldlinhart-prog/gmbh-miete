// api/contact.js — GmbH-Miete.de
const RESEND_API_KEY = process.env.RESEND_API_KEY;
const CONTACT_FROM = process.env.CONTACT_FROM || 'noreply@pan21.com';
const CONTACT_TO = process.env.CONTACT_TO || 'gmbhmiete@pan21.com';
...
module.exports = async (req, res) => {
  ...
  try {
    ...
    var html = '<h2>Neue Anfrage über gmbh-miete.de</h2>' +
    ...
    var resendRes = await fetch('https://api.resend.com/emails', {
      ...
      body: JSON.stringify({
        from: 'GmbH-Miete.de <' + CONTACT_FROM + '>',
        to: [CONTACT_TO],
        reply_to: email,
